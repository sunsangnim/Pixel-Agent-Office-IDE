...
export interface LayoutSnapshot {
  layout: OfficeLayoutSave
  removedDeskIds: string[]
}
...
export class OfficeScene extends Phaser.Scene {
  ...
  undoLayoutChange(): void {
    undoLayoutChangeImpl(this)
  }

  redoLayoutChange(): void {
    redoLayoutChangeImpl(this)
  }

  listLayoutPresets(): LayoutPresetSummary[] {
    return listLayoutPresetsImpl(this)
  }

  saveLayoutPreset(name: string): boolean {
    return saveLayoutPresetImpl(this, name)
  }

  loadLayoutPreset(name: string): boolean {
    return loadLayoutPresetImpl(this, name)
  }

  deleteLayoutPreset(name: string): void {
    deleteLayoutPresetImpl(this, name)
  }
