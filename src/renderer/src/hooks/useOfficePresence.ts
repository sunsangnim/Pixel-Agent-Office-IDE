...
export function useOfficePresence(
  ...
  return useMemo(() => resolveOfficePresence(profiles, instances, runtimeStates, meetingActive, manuallyOffDutyIds),
    [profiles, instances, runtimeStates, meetingActive, manuallyOffDutyIds])
}
